...
| CISS | Kyuhwan Yeom (Yonsei University)| Embedding Two-View Knowledge Graphs with Class Inheritance and Structural Similarity | Knowledge Graph Embedding | The paper introduces CISS, a model that enhances two-view knowledge graph (KG) embeddings by considering class inheritance and structural similarity between ontology-view and instance-view KGs. The approach models fine-grained class representations and reduces the structural gap between two views for better link prediction and entity typing tasks. | [Link](https://doi.org/10.1145/3637528.3671941) | [Code] |
